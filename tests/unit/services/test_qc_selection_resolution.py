...
from sapphire_flow.services.qc import resolve_selection
...
class TestResolveSelection:
    def test_a_matching_cadence_selects_its_rules(self) -> None:
        ...
        step, n_rules = resolve_selection(obs, _rule_set(600))[(_STATION, "discharge")]
    ...
    def test_a_single_row_infers_no_cadence_rather_than_fabricating_one_hour(
        ...
        step, n_rules = resolve_selection([_obs(0)], _rule_set(3600))[
            (_STATION, "discharge")
        ]
    ...
    def test_groups_are_resolved_independently(self) -> None:
        ...
        resolved = resolve_selection([*obs, lone], _rule_set(600))
