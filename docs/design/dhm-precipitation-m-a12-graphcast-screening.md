...
DHM_PRECIP_XLSX=data/dhm_precip/combined_precipitation_37_stations.xlsx \
  uv run python -m scripts.dhm_precip.graphcast_ifs_compare --seasons 2022 2023 2024 2025
```
...
`tests/unit/scripts/test_graphcast_acquire.py` (18 tests, no network — every extraction test opens a
