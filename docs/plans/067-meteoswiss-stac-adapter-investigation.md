...
**Status**: READY
**Date**: 2026-04-21 (revised 2026-04-21 — four critical-review passes; [5] post-T1 scope expansion to include `_CYCLE_HOURS` cadence correction — T1.b discovered MeteoSwiss publishes at 6 h cadence, not the 3 h cadence the constant assumes. D2's derivation divisor changes from `/ 3.0` to `/ 6.0`; new decision D7 and new sub-task T3.d added.)
