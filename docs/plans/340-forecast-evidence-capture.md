...
**T1 sizing evidence (2026-09-24, synthetic).** A six-station exercise with 720 hourly observations and 240 future forcing steps per station, 20 members and 120 forecast steps measured 0.262 s for capture and 0.651 s for database writes. Six evidence rows shared seven content-addressed blobs totaling 302,653 bytes. This is a development-machine measurement, not a Nepal staging capacity result; repeat with actual CHWRR station/model mixes before the T2 publication gate.
