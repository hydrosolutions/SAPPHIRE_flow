...
- **Planning and independent-review agents may read a DRAFT plan, but implementation agents may not execute it.** ⚖️ **READY is set by the ORCHESTRATOR session only after at least one independent review is complete** (delegated by the owner, 2026-09-17); see § Orchestration authority.
